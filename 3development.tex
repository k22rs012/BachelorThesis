...
\begin{minipage}{0.52\linewidth}
  ...
  \begin{tabular}{|c|c|}
    \hline
    モデルNo. & Seeed XIAO ESP32C6 \\ \hline \hline
    ...
    動作電圧 & 3.3 V \\ \hline
    入力電圧 & 5 V（USB）/ 5 V・3.3 Vピン \\ \hline
    ボード寸法 & 約21.0 $\times$ 17.5 mm \\ \hline
...
\begin{minipage}{0.42\linewidth}
  \centering
  \includegraphics[width=\linewidth]{./figures/Arduino}
...
\begin{minipage}{0.52\linewidth}
  \centering
  \captionof{table}{Arduino MKR WiFi 1010}
  ...
  \begin{tabular}{|c|c|}
    \hline
      ...
      ボード寸法 & 約61.5 $\times$ 25.0 mm \\ \hline
